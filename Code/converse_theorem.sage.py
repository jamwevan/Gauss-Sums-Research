...
_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_9 = Integer(9); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3); _sage_const_7 = Integer(7)# This file was *autogenerated* from the file fL_bar.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(_sage_const_2 ); _sage_const_0 = Integer(_sage_const_0 ); _sage_const_1 = Integer(_sage_const_1 ); _sage_const_9 = Integer(_sage_const_9 ); _sage_const_5 = Integer(_sage_const_5 )
...
class GaussSumTable:
    ...
    def find_counterexamples(self):
        counterexamples = []
        for l, q in [(_sage_const_2 , _sage_const_5 ), (_sage_const_3 , _sage_const_7 )]:
