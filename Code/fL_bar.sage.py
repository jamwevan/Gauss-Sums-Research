...
_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_9 = Integer(9); _sage_const_5 = Integer(5)# Import necessary functions from SageMath
...
class GaussSumTable:
    ...
    def compute_gauss_sum(self, theta, alpha):
        total = _sage_const_0   # Initialize sum
    ...
    # -----------------------------------------------
    def log(self, x):
        return x.log(self.generator) if x != _sage_const_0  else _sage_const_0   # Log(0) is undefined, return 0
...
# -----------------------------------------------
def max_power(N, l):
    m = _sage_const_0   # Initialize exponent count
    while N % l == _sage_const_0 :  # While N is divisible by l
        N //= l  # Divide N by l
        m += _sage_const_1   # Increase exponent count
...
def complex_gauss_sum_table(q, l):
    ...
    if prime_power_result[_sage_const_1 ] == _sage_const_0 :  # If q is not a prime power, raise error
