...
# This file was *autogenerated* from the file conjecture.sage
...
if __name__ == "__main__":
    ...
    l_upper = Integer(input("ℓ_max: "))
    q_upper = Integer(input("q_max: "))
            ...
            for q_candidate in range(_sage_const_2 , q_upper + _sage_const_1 ):
                ...
                if prime_power_data[_sage_const_1 ] != _sage_const_0:
                    ...
                    for (_, _, identical_groups) in counterexamples:
                        ...
                        counterexample_flag = largest_subgroup_size >= _sage_const_3 
