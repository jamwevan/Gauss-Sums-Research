...
_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_66 = Integer(66)# This file was *autogenerated* from the file converse_theorem_loop.sage
from sage.all_cmdline import *   # import sage library
    ...
    for l_candidate in range(_sage_const_2 , l_upper + _sage_const_1 ):
        ...
        if is_prime(l_val):
            ...
            for q_candidate in range(_sage_const_2 , q_upper + _sage_const_1 ):
                ...
                if prime_power_data[_sage_const_1 ] != _sage_const_0:  # it's a prime power
                    ...
                    for (_, _, identical_groups) in counterexamples:
                        largest_size = len(identical_groups[_sage_const_0 ])
